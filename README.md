...
<p align="center">
	...
	<br>
	<em>Example skin images from the ISIC dataset and their associ-ated diagnostically relevant imaging features as identified by GSIn-quire using CancerNet-SCa-A. The bright regions indicate theimaging features identified to be relevant.</em>
</p>
...
For a detailed description of the methodology behind COVID-Net and a full description of the COVIDx dataset, please click [here](https://arxiv.org/abs/2011.10702v1).
